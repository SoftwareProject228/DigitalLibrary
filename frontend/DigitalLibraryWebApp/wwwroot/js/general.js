...
$(document).ready(function() {
  ...
  var sectionArray = [];// get array of section ids, that exist in DOM - set of tags
...
$('input[type="text"]').keyup(function(e){
    if(e.which == 13){// ENTER key pressed
      $('.command').hide();
      var destination = $('input[type="text"]').val();//Gets the value of the value attribute
      $('section[id="' + destination + '"]').addClass('open').siblings().removeClass('open');// Display section with id == destination and hide all others
